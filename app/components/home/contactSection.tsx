  ...
  return (
    <section className="py-20 w-full lg:max-w-[1024px]" id="contact">
      ...
      <Card className="bg-white text-black shadow-lg ">
        <CardBody className="grid sm:grid-cols-2 items-start justify-start gap-4 p-6 sm:p-8">
          <div className="pl-4">
          ...
          <div className="pl-4">
            ...
            <ul className="list-disc">
              <li className="mt-2">Jours : Lundi | Mardi | Jeudi | Vendredi</li>
              <li className="mt-2">Horaires : 8h-19h</li>
